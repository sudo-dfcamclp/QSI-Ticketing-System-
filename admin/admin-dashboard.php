...
<body class="bg-gray-100 min-h-screen">
    ...
    <!--
        ...
        sidebar.js automatically adjusts the content position
        when the sidebar is expanded, minimized, or on mobile.
    -->
        ...
        <div class="container mx-auto px-6 py-10 max-w-7xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-blue-100 text-blue-600 p-3 rounded-xl">
                                ...
                                >
                                    ...
                                    <path
                                        ...
                                        stroke-width="2"
                                        d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-5a4 4 0 11-8 0 4 4 0 018 0zm6 3a3 3 0 11-6 0 3 3 0 016 0z"
                                    />
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <!-- Long Box 2: Department Overview -->
                    <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
